...
@keyframes rgb-border {
    ...
    25% { border-image: linear-gradient(45deg, #00ff80, #8000ff, #ff8000, #00ff80) 1; }
    50% { border-image: linear-gradient(45deg, #8000ff, #ff8000, #0080ff, #8000ff) 1; }
    75% { border-image: linear-gradient(45deg, #ff8000, #0080ff, #ff0080, #ff8000) 1; }
...
/* Lightbox améliorée - adaptation automatique */
.lightbox {
    display: none;
    position: fixed;
    top: 0;
...
/* Icône vidéo pour les images avec YouTube */
...
/* Responsive pour les icônes vidéo */
@media (max-width: 768px) {
    .gallery-item[data-has-video="oui"]::after {
        width: 25px;
        height: 25px;
...
/* ========================================
   PAGE CONDITIONS GÉNÉRALES - DESIGN SOBRE
======================================== */

/* Style gouvernemental sobre - MODE CLAIR */
.conditions-page {
    background: #ffffff;
    color: #333333;
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
...
/* Styles mode sombre pour les articles */
...
.conditions-page.dark-theme .condition-item ul,
.conditions-page.dark-theme .condition-item li {
    color: #ffffff;
}

.conditions-page.dark-theme .condition-item strong {
    color: #ffffff;
}
...
/* Styles mode sombre pour contact et footer */
...
.conditions-page.dark-theme .contact-urgence a {
    color: #ffffff;
}
...
.conditions-page.dark-theme .btn {
    background: #0066cc;
}
...
.conditions-page .footer-content {
    justify-content: center;
}

.conditions-page .footer-link {
    color: #ffffff;
    border-color: #ffffff;
}

/* Responsive pour design sobre */
@media (max-width: 768px) {
    .conditions-content {
        padding: 25px 20px;
        margin: 10px;
