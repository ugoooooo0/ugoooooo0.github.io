...
function createLightboxHTML() {
    ...
    prevBtn.addEventListener('click', () => currentImageIndex > 0 && loadMedia(currentImageIndex - 1));
    nextBtn.addEventListener('click', () => currentImageIndex < currentGallery.length - 1 && loadMedia(currentImageIndex + 1));
...
function loadMedia(index) {
    ...
    const videoContainer = document.querySelector('.lightbox-video-container');
